    ...
    config = function()
      require('telescope').setup {
        ...
        defaults = {
          ...
          sorting_strategy = 'ascending', -- Ensures items are sorted from top to bottom
        },
        extensions = {
          ['ui-select'] = {
      ...
      vim.keymap.set('n', '\\', ':Telescope file_browser path=%:p:h select_buffer=true<CR>', { desc = '[F]ile [B]rowser' })
